...
import { Stack, Flex, Title, Button, Fieldset, TextInput, Textarea, TagsInput, Select, Switch, Group, Modal, Radio, Text } from "@mantine/core";
...
export const EditListingModal = ({opened, onClose, listing, setListings} : EditListingModalProps) => {
  ...
  return (
    <Modal opened={opened} onClose={onClose} title="Delete application" centered size="xl" zIndex={100}>
      <Stack gap="md" p="md">
