import { Button, Fieldset, Flex, TextInput, Title, Text } from "@mantine/core";
...
export function EditProfile() {
    ...
    const accountLabel = userData?.isAdmin
        ? "Admin"
        : isBusiness
            ? "Business"
            : "Jobseeker";
                        ...
                        <Flex gap={10} direction='column' m='auto'>
                            ...
                            {isJobseeker && (
                                <Fieldset legend="Jobseeker Details">
                                    <JobseekerFields register={register} errors={errors} control={control} disabled={isDisabled} />
                                </Fieldset>
                            )}

                            {isBusiness && (
                                <Fieldset legend="Business Details">
                                    <BusinessFields register={register} errors={errors} control={control} disabled={isDisabled} />
                                </Fieldset>
                            )}
                            ...
                            <Flex direction="column" gap={5} w="50%" mx="auto">
                                ...
                                <Button
                                    disabled={isDisabled || !isValid || !isDirty}
                                    type="submit"
                                > Update Info 
                                </Button>
                            </Flex>
