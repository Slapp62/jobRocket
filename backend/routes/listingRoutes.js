...
router.post("/", authenticateUser, businessAuth, listingsLimiter, listingValidation, createListing);

// Update listing by ID
router.put("/:id", authenticateUser, listingCreatorAuth, listingValidation, updateListing);
