...
- [ ] **4.5** Return 200 with user profile data (exclude password, isAdmin, \_\_v)
...
- [ ] **5.5** Return 200 with updated user data (exclude isAdmin, password, \_\_v)
...
- [ ] **6.5** Update user and return 200 (exclude password, \_\_v)
